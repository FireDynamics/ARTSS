...
class Domain:
    ...
    def print_info(self):
        ...
        print(
            f"Domain size inner cells: {self.domain_param['nx'] - 2} {self.domain_param['ny'] - 2} {self.domain_param['nz'] - 2}\n"
            f"step size (x|y|z): ({self.domain_param['dx']}|{self.domain_param['dy']}|{self.domain_param['dz']})\n"
            f"pcoords (x y z): ({self.domain_param['X1']}|{self.domain_param['X2']}) ({self.domain_param['Y1']}|{self.domain_param['Y2']}) ({self.domain_param['Z1']}|{self.domain_param['Z2']})")
        for o in self.obstacles:
            print(f"-- Obstacle {o['name']}\n"
                  ...
                  f"   pcoords (x y z): ({o['pox1']}|{o['pox2']}) ({o['poy1']}|{o['poy2']}) ({o['poz1']}|{o['poz2']})")
