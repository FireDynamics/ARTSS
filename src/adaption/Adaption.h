...
class Adaption {
public:
    explicit Adaption(Settings const &sets, FieldController *field_controller);
    ...
    static bool adapt_x_direction(Settings const &sets, const real *f, real check_value, size_t no_buffer_cell, real threshold, long *p_shift_x1, long *p_shift_x2, size_t minimal, bool reduce);
    static bool adapt_x_direction_serial(Settings const &sets, const real *f, real check_value, size_t no_buffer_cell, real threshold, long *p_shift_x1, long *p_shift_x2, size_t minimal, bool reduce);
    static bool adapt_y_direction(Settings const &sets, const real *f, real check_value, size_t no_buffer_cell, real threshold, long *p_shift_x1, long *p_shift_x2, size_t minimal, bool reduce);
    static bool adapt_y_direction_serial(Settings const &sets, const real *f, real check_value, size_t no_buffer_cell, real threshold, long *p_shift_x1, long *p_shift_x2, size_t minimal, bool reduce);
