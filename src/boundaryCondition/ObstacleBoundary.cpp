...
/// \param  field   Field where the BC should be applied to
/// \param  mjl MultipleJoinedList which contains the index lists of all obstacles
/// \param  id id of obstacle which BC should be set
...
void apply_neumann(Field &field, MultipleJoinedList *mjl,
    ...
    apply_boundary_condition(field, mjl, id,
                             sign_reference_index, reference_index,
                             -value, POSITIVE_SIGN);
}
}  // namespace
...
/// \brief  Applies boundary condition for obstacle boundary
/// \param  field   Field
/// \param  index_fields MultipleJoinedList which contains the index lists of all obstacles
/// \param  boundary_data Boundary data object of obstacle
/// \param  id id of obstacle which BC should be set
