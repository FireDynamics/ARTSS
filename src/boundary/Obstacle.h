...
public:
    ...
    size_t getCoordinates_i2();
    size_t getCoordinates_j2();
    size_t getCoordinates_k2();
...
private:
    ...
    ////size defined in xml
    //size_t m_size_obstacleSliceZ; //FRONT and BACK
    //size_t m_size_obstacleSliceY; //TOP and BOTTOM
    //size_t m_size_obstacleSliceX; //LEFT and RIGHT
