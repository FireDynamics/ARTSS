...
public:
    ...
    size_t inline GetNx() {return static_cast<size_t> (std::round(GetLx() / Getdx() + 2));};
    size_t inline GetNy() {return static_cast<size_t> (std::round(GetLy() / Getdy() + 2));};
    size_t inline GetNz() {return static_cast<size_t> (std::round(GetLz() / Getdz() + 2));};
    size_t inline GetNx(size_t level) {return static_cast<size_t> (std::round(GetLx() / Getdx(level) + 2));};
    size_t inline GetNy(size_t level) {return static_cast<size_t> (std::round(GetLy() / Getdy(level) + 2));};
    size_t inline GetNz(size_t level) {return static_cast<size_t> (std::round(GetLz() / Getdz(level) + 2));};
    ...
    size_t inline GetIndexx1(size_t level) { return static_cast<size_t> (std::round((m_x1 - m_X1) / Getdx(level)))+1; }
    size_t inline GetIndexx2(size_t level) { return static_cast<size_t> (std::round((m_x2 - m_X1) / Getdx(level))); }
    size_t inline GetIndexy1(size_t level) { return static_cast<size_t> (std::round((m_y1 - m_Y1) / Getdy(level)))+1; }
    size_t inline GetIndexy2(size_t level) { return static_cast<size_t> (std::round((m_y2 - m_Y1) / Getdy(level))); }
...
private:
    ...
    void calcMGValues();
    static real calcNewCoord(real oldCoord , long shift, real cellwidth);
    static bool setNewValue(long shift, real startCoord_p, real endCoord_p, real oldCoord, real cellwidth, real *newCoord);
